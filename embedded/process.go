...
// expects https://github.com/fgeth/tor-static to be cloned at
// $GOPATH/src/github.com/fgeth/tor-static as if it was fetched with go get. 
// If you use go modules the expected path would be $GOPATH/pkg/mod/github.com/fgeth/tor-static
...
import (
	...
	tor035 "process/embedded/tor-0.3.5"
)
